"""TDD tests for CLI commands (LangChain)."""
...
from rag_langchain.chain import SourceInfo
from rag_langchain.cli import app
from rag_langchain.pipeline import AskResult, IndexResult
...
class TestBasicCommands:
    ...
    @patch("rag_langchain.cli.index_documents")
    ...
    @patch("rag_langchain.cli.ask_question")
